<?php get_header(); ?>
<style>
/* Reset complet pour éliminer l'écart */
body.error404 {
    margin: 0 !important;
    padding: 0 !important;
}
...
.error-page {
    ...
    margin: 0 !important;
    padding: 0 !important;
    min-height: calc(100vh - 80px); /* Ajustez selon la hauteur de votre header */
}

.error-404 {
    margin-left: 5% !important;
    margin-top: 0 !important;
    padding-top: 2rem !important; /* Espacement du haut du contenu */
    color: white;
}

/* Supprimer l'écart potentiel du header */
.error404 .esgi-header {
    margin-bottom: 0 !important;
}

/* Supprimer les marges par défaut du main */
.error404 main {
    margin: 0 !important;
    padding: 0 !important;
}
